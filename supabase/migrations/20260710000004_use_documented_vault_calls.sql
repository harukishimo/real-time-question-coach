-- Use the public Supabase Vault call forms and let Vault supply every
-- optional argument, including its managed encryption metadata.
--
-- Passing NULL placeholders for optional arguments is not equivalent across
-- Vault versions: it can override a function default and lead to a NOT NULL
-- violation inside the Vault implementation. The documented one/two-argument
-- forms avoid that ambiguity.
